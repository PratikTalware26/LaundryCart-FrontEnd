...
const PastorderPage = () => {
  ...
  const gettingData = async () => {
    await fetch("https://laundrycart-backend-zg7o.onrender.com/getOrder", {
  ...
  const deleteOrder = async() => {
    ...
    try {
      console.log(orderId);
      await fetch(`https://laundrycart-backend-zg7o.onrender.com/deleteOrder/${orderId}`, {
        method: "DELETE",
        headers: {
          authtoken: token,
        },
  ...
  const changeHandler = (id) => {
    setVisible(!Visible);
    setorderId(id);
    fetch(`https://laundrycart-backend-zg7o.onrender.com/order/${id}`, {
      method: "GET",
      headers: {
        authtoken: token,
      },
